...
.contact_information {
    border-radius: 3px;
    padding: 110px 30px;
    background: var(--main, linear-gradient(105deg, #453D89 4.3%, #C8499A 98.36%));
}
...
@media screen and (max-width: 600px) {
    ...
    .contact_address_information address {
        margin-left: 12px;
    }
